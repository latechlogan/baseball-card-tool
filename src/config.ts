...
const thresholds: ScoringThresholds = {
  ...
  opsStrongBuy: thresholdsJson.opsStrongBuy,
  opsModerate: thresholdsJson.opsModerate,
  opsWatch: thresholdsJson.opsWatch,
  isoStrongBuy: thresholdsJson.isoStrongBuy,
  isoModerate: thresholdsJson.isoModerate,
  isoWatch: thresholdsJson.isoWatch,
  obpStrongBuy: thresholdsJson.obpStrongBuy,
  obpModerate: thresholdsJson.obpModerate,
  xbhPctElite: thresholdsJson.xbhPctElite,
  xbhPctMin: thresholdsJson.xbhPctMin,
  xbhPctLow: thresholdsJson.xbhPctLow,
  bbKRatioElite: thresholdsJson.bbKRatioElite,
  bbKRatioMin: thresholdsJson.bbKRatioMin,
  bbKRatioLow: thresholdsJson.bbKRatioLow,
  katohElite: thresholdsJson.katohElite,
  katohModerate: thresholdsJson.katohModerate,
  katohLow: thresholdsJson.katohLow,
